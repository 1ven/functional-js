...
const _averageDollarValue = _.compose(_average, _.map(_.prop('dollar_value')));
...
const _availablePrices = _.compose(
  _.join(', '),
  _.map(formatPrice),
...
const _fastestCar = _.compose(
  _.prop('name') + ' - is the fastest',
  _.last,
